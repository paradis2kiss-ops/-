              ...
              >
                <div className="flex flex-col sm:flex-row gap-6">
                  ...
                  <div className="flex-1 min-w-0 text-center sm:text-left">
                    <h3 className={`font-surround font-bold text-xl md:text-2xl mb-1 leading-snug ${isDarkMode ? 'text-white' : 'text-day-text'}`} style={{fontFamily: 'Cafe24Ssurround, Pretendard, sans-serif'}}>{book.title}</h3>
                    ...
                    <p className={`text-base italic mb-4 leading-relaxed font-body ${isDarkMode ? 'text-white/90' : 'text-day-text/90'}`}>"{book.description}"</p>
                    
                    <div className={`p-4 rounded-xl mb-4 text-sm ${isDarkMode ? 'bg-white/10 border border-white/5' : 'bg-day-bg'}`}>
